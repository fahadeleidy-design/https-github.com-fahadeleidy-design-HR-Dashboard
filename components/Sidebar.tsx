...
interface SidebarProps {
  ...
  // FIX: Add govDocAlertCount to props to show alerts for governmental documents.
  govDocAlertCount: number;
}

const NavItem: React.FC<{ tab: Tab; activeTab: Tab; setActiveTab: (tab: Tab) => void; label: string; icon: React.ReactNode, alertCount?: number }> = ({ tab, activeTab, setActiveTab, label, icon, alertCount = 0 }) => (
    <li>
        <button
            onClick={() => setActiveTab(tab)}
            className={`flex items-center justify-between w-full p-3 text-base font-normal rounded-lg transition-colors duration-200 ${
                activeTab === tab 
...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onLanguageChange, lang, vehicleAlertCount, govDocAlertCount }) => {
    const logoUrl = "data:image/png;base64,";
    // FIX: Add gov-docs NavItem to the sidebar
    const navItems: { tab: Tab, label: string, icon: React.ReactNode, alertCount?: number }[] = [
        ...
        { tab: 'vehicles', label: 'Vehicles', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M17 14l-5-5-5 5" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 19V9" /><path strokeLinecap="round" strokeLinejoin="round" d="M8.5 14H4a2 2 0 01-2-2V7a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-4.5" /></svg>, alertCount: vehicleAlertCount },
        { tab: 'gov-docs', label: 'Gov Docs', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>, alertCount: govDocAlertCount },
